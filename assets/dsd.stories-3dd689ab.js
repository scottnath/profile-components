...
<script type="module">
  ...
  injectPostDSD();
<\/script>
`,language:"html"})]})}function N(A={}){const{wrapper:C}=Object.assign({},x(),A.components);return C?n.jsx(C,Object.assign({},A,{children:n.jsx(h,A)})):h(A)}const aA={title:"DevTo/Declarative Shadow DOM",parameters:{docs:{page:N}},tags:["autodocs"],decorators:[A=>`${A()}
    <script>
  ...
  `]},d={loaders:[async({args:A})=>({dsdOutput:await await q.dsd(A)})],render:(A,{loaded:{dsdOutput:C}})=>`
    ...
    `,args:{...s(L)},play:async({args:A,canvasElement:C,step:o})=>{const t=await _(C);await b(t,A),await T(t,A)}},l={loaders:[async({args:A})=>({dsdOutput:await await H(A)})],render:(A,{loaded:{dsdOutput:C}})=>`
      <devto-user-dsd data-theme="dark">${C}</devto-user-dsd>
  
    `,args:{...F(O),latest_post:stringinator(s(p)),popular_post:stringinator(s(u))},play:async({args:A,canvasElement:C,step:o})=>{const t=await P(C),a={...A,latest_post:{...s(p)},popular_post:{...s(u)}};await R(t,a),await E(t,a)}};var g,f,v;d.parameters={...d.parameters,docs:{...(g=d.parameters)==null?void 0:g.docs,source:{originalSource:`{
  loaders: [async ({
    args
  }) => ({
...
}`,...(y=(D=l.parameters)==null?void 0:D.docs)==null?void 0:y.source}}};const rA=["Post","User"];export{d as Post,l as User,rA as __namedExportsOrder,aA as default};
//# sourceMappingURL=dsd.stories-3dd689ab.js.map
