import{s as S,g as F,h as E,p as m,a as u,b as j}from"./index-2a821587.js";import{J as L,e as a}from"./index-9dd2e3b9.js";import"./_commonjsHelpers-de833af9.js";import"./uniq-b54251fb.js";import"./_getTag-6a63926d.js";import"./index-03bbf7d1.js";import"./index-d38bc732.js";const V="article",D=1630208,P="Profile Components: display social profiles in native web components",q="Profile-components are a set of web components with zero dependencies that display publicly-available profile information from various social networks. Currently two: GitHub and dev.to.",G="Oct 10",B="profile-components-display-social-profiles-in-native-web-components-49b2",N="/scottnath/profile-components-display-social-profiles-in-native-web-components-49b2",I="https://dev.to/scottnath/profile-components-display-social-profiles-in-native-web-components-49b2",J=0,R=0,Z=24992,U="2023-10-10T16:19:14Z",W=0,X="https://res.cloudinary.com/practicaldev/image/fetch/s--5oEkYDnE--/c_imagga_scale,f_auto,fl_progressive,h_420,q_auto,w_1000/https://dev-to-uploads.s3.amazonaws.com/uploads/articles/svvid1vh9qtimahal8c7.jpeg",O="https://res.cloudinary.com/practicaldev/image/fetch/s--cT2BXB9L--/c_imagga_scale,f_auto,fl_progressive,h_500,q_auto,w_1000/https://dev-to-uploads.s3.amazonaws.com/uploads/articles/svvid1vh9qtimahal8c7.jpeg",Y="https://scottnath.com/blahg/profile-components/",$="2023-10-10T16:19:15Z",K="2023-10-11T20:26:42Z",Q=null,AA="2023-10-10T16:19:14Z",CA="2023-10-10T16:19:14Z",eA=7,sA="webcomponents, opensource, javascript, css",nA=["webcomponents","opensource","javascript","css"],aA=`<p>Profile Components is a set of web components with zero dependencies that display publicly-available profile information from various social networks. Currently two: GitHub and dev.to.</p>
...
}`,...(w=(v=r.parameters)==null?void 0:v.docs)==null?void 0:w.source}}};var b,y,_;i.parameters={...i.parameters,docs:{...(b=i.parameters)==null?void 0:b.docs,source:{originalSource:`{
  args: {
    id: postProfileComponents.id,
    fetch: true
  },
  parameters: {
    mockData: [generateMockResponse(postProfileComponents, 'article')]
  },
  play: async ({
    args,
    canvasElement,
...
}`,...(_=(y=i.parameters)==null?void 0:y.docs)==null?void 0:_.source}}};var k,x,H;p.parameters={...p.parameters,docs:{...(k=p.parameters)==null?void 0:k.docs,source:{originalSource:`{
  args: {
    ...Fetch.args,
...
}`,...(H=(x=p.parameters)==null?void 0:x.docs)==null?void 0:H.source}}};var T,z,M;c.parameters={...c.parameters,docs:{...(T=c.parameters)==null?void 0:T.docs,source:{originalSource:`{
  args: {
    id: 'not-a-real-id',
    fetch: true
  },
...
}`,...(M=(z=c.parameters)==null?void 0:z.docs)==null?void 0:M.source}}};const gA=["Post","Fetch","FetchOverides","FetchError"];export{i as Fetch,c as FetchError,p as FetchOverides,r as Post,gA as __namedExportsOrder,uA as default};
//# sourceMappingURL=post.stories-63b8b52b.js.map
